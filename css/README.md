...
`66-home-cards.css` owns the main-screen dashboard card row, collapsed dashboard row, Weather card, ActivityWatch mini card, and the related Dashboard Settings controls.
