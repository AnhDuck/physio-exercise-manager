...
- `workload-card.js`: optional Workload Today dashboard card, Dashboard Settings visibility/timer-cue controls, one-button work timer, whole-app running border, start/reminder sound cues, quick total adjustments, personal-day rollover splitting, long-timer review flagging, and shared ActivityWatch Workload overlay comparison helpers.
