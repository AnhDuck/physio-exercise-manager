...
- `workload-card.js`: optional Workload Today dashboard card, Dashboard Settings visibility toggle, one-button work timer, quick total adjustments, personal-day rollover splitting, long-timer review flagging, and shared ActivityWatch Workload overlay comparison helpers.
