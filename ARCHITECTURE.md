...
- `weather-card.js`: Open-Meteo weather card, current details including humidity/wind/UV/sun times, daily-brain advisory/highlight/mood rules, location search, cached weather result, request throttling/rate-limit cooldowns, and weather Settings controls.
